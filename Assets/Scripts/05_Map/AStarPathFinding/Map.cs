...
//		mPathFinder.Formula = E_HeuristicFormula.Manhattan;
...
//	{
//		return new Vector2Int((int)((point.x - position.x + cTileSize / 2.0f) / (float)(cTileSize)),
...
//		{
//			if (mouseTileX != lastMouseTileX || mouseTileY != lastMouseTileY ||
//				Input.GetKeyDown(KeyCode.Mouse1) || Input.GetKeyDown(KeyCode.Mouse2))
//			{
