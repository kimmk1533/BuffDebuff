...
public class BuffFileManager : MonoBehaviour
{
	#region 변수
	#endregion
	...
	#region 매니저
	private static SpreadSheetManager M_SpreadSheet => SpreadSheetManager.Instance;
	#endregion
	...
	public void CreateAllBuff(bool load, /*bool script, */bool asset, bool switchCase)
	{
		...
		M_SpreadSheet.LoadJsonData(dataSet);
	...
	{
		string path = Path.Combine(Application.dataPath, "Resources", "BuffData", buffData.buffType.ToString());
