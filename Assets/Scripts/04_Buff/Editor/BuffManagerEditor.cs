...
public class BuffManagerEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		m_CreateUIAsset = GUILayout.Toggle(m_CreateUIAsset, " Create UI ScriptableObject");
		...
		{
			buffManager.CreateAllBuff(m_LoadBuff, m_CreateScript, m_CreateAsset, m_CreateUIAsset, m_UpdateBuffManager);
		}
	}
}